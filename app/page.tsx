  ...
  return (
    <div className={`${styles.general} ${font.className}`}>
      ...
      <div className={hStyles.header}>
            <Image alt="Avatar" className={hStyles.avatar} src={avatars[currentPage-1]} onClick={() => setPage(1)} style={{scale: visible ? 1 : 0.95}} />

            <a href="/lolololol">
                <Image alt="Definetly not a Rickroll button" width={62} src="rayf.png" style={{marginLeft: "40px", marginRight: "45px"}} />
            </a>
